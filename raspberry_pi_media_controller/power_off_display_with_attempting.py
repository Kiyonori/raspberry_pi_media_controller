...
def main():
    ...
    logging.info('The system will turn off the display.')
    ...
    while True:
        ...
        logging.info(
            'Attempt %d times: Turn off the power to the display. Wattages: %s' %
            (
                int(attempt_count + 1),
    ...
    last_message: str = get_last_message_on_power_off_display(
        attempt_count,
        power_status,
    )
