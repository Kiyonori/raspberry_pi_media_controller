...
from raspberry_pi_media_controller.modules.analog_digital_converter.get_wattages_on_display import \
    get_wattages_on_display
...
def main():
    ...
    while True:
        ...
        power_status: DisplayPowerStatusEnum = get_display_power_status(wattages)
